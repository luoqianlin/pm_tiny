...
| yaml-cpp | 0.7.0 | https://github.com/jbeder/yaml-cpp | MIT | Existing bundled source |
...
CMake verifies the versions used by the process-list renderer. Third-party tests, examples and install targets are not part of the PM_Tiny build.
